...
export default function PaperSubmissionForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md py-24">
      ...
      <h1 className="text-4xl font-bold text-center mb-6 text-orange-600">Paper Submission Form</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="px-6 py-3 bg-orange-500 text-white font-medium rounded-md hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
