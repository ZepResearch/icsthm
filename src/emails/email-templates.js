export function getUserEmailTemplate(data) {
    ...
    <body>
      ...
      <div class="content">
        ...
        <p>Thank you for submitting your paper titled <span class="highlight">"${data.paper_title}"</span> to the International Conference on Sustainable Tourism & Hospitality Management.</p>
  ...
  export function getAdminEmailTemplate(data, fileUrl) {
    ...
    <body>
      ...
      <div class="content">
        <p>A new paper has been submitted to the International Conference on Sustainable Tourism & Hospitality Management.</p>
